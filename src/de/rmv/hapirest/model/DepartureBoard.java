 ...
 *         &lt;element ref="{http://hacon.de/hafas/proxy/hafas-proxy}Departure" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlRootElement(name = "DepartureBoard", namespace = "http://hacon.de/hafas/proxy/hafas-proxy")
public class DepartureBoard
    extends CommonResponseType
{

    @XmlElement(name = "Departure", namespace = "http://hacon.de/hafas/proxy/hafas-proxy")
